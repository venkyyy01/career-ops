...
import { getStatusRank } from './lib/statuses.mjs';
import { normalizeCompany, parseScore, parseAppLine, getAppsFile } from './lib/tracker.mjs';
...
const STATUS_RANK = getStatusRank();
